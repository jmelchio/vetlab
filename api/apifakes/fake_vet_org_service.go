...
type FakeVetOrgService struct {
	...
	FindVetOrgByIDStub        func(ctx context.Context, orgID uint) (*model.VetOrg, error)
...
func (fake *FakeVetOrgService) FindVetOrgByID(ctx context.Context, orgID uint) (*model.VetOrg, error) {
