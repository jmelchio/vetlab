...
var _ = Describe("User", func() {
	Describe("User object can be transformed from and to Json", func() {
		...
		BeforeEach(func() {
			...
			jsonUser = `{"user_id":"some-user-id","user_name":"some-user-name","first_name":"some-first-name","last_name":"some-last-name","email":"user@server.com","password_hash":"some-password-hashed","org_id":"some-org-id"}`
		})
