...
func (fake *FakeUserRepo) GetByID(arg1 string) error {
...
func (fake *FakeUserRepo) GetByIDReturns(result1 error) {
...
func (fake *FakeUserRepo) GetByIDReturnsOnCall(i int, result1 error) {
	fake.GetByIDStub = nil
...
var _ model.UserRepo = new(FakeUserRepo)
