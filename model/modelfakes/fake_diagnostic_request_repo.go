...
type FakeDiagnosticRequestRepo struct {
	CreateStub        func(model.DiagnosticRequest) (*model.DiagnosticRequest, error)
	...
	UpdateStub        func(model.DiagnosticRequest) (*model.DiagnosticRequest, error)
	...
	GetByIDStub        func(string) (*model.DiagnosticRequest, error)
	...
	GetByOrgIDStub        func(string) ([]model.DiagnosticRequest, error)
...
func (fake *FakeDiagnosticRequestRepo) Create(arg1 model.DiagnosticRequest) (*model.DiagnosticRequest, error) {
...
func (fake *FakeDiagnosticRequestRepo) CreateReturns(result1 *model.DiagnosticRequest, result2 error) {
	fake.CreateStub = nil
...
func (fake *FakeDiagnosticRequestRepo) CreateReturnsOnCall(i int, result1 *model.DiagnosticRequest, result2 error) {
	fake.CreateStub = nil
...
func (fake *FakeDiagnosticRequestRepo) Update(arg1 model.DiagnosticRequest) (*model.DiagnosticRequest, error) {
...
func (fake *FakeDiagnosticRequestRepo) UpdateReturns(result1 *model.DiagnosticRequest, result2 error) {
	fake.UpdateStub = nil
...
func (fake *FakeDiagnosticRequestRepo) UpdateReturnsOnCall(i int, result1 *model.DiagnosticRequest, result2 error) {
	fake.UpdateStub = nil
...
func (fake *FakeDiagnosticRequestRepo) GetByID(arg1 string) (*model.DiagnosticRequest, error) {
...
func (fake *FakeDiagnosticRequestRepo) GetByIDArgsForCall(i int) string {
	fake.getByIDMutex.RLock()
	defer fake.getByIDMutex.RUnlock()
...
func (fake *FakeDiagnosticRequestRepo) GetByOrgID(arg1 string) ([]model.DiagnosticRequest, error) {
...
func (fake *FakeDiagnosticRequestRepo) GetByOrgIDCallCount() int {
	fake.getByOrgIDMutex.RLock()
	defer fake.getByOrgIDMutex.RUnlock()
	return len(fake.getByOrgIDArgsForCall)
}

func (fake *FakeDiagnosticRequestRepo) GetByOrgIDArgsForCall(i int) string {
	fake.getByOrgIDMutex.RLock()
	defer fake.getByOrgIDMutex.RUnlock()
	return fake.getByOrgIDArgsForCall[i].arg1
}

func (fake *FakeDiagnosticRequestRepo) GetByOrgIDReturns(result1 []model.DiagnosticRequest, result2 error) {
...
func (fake *FakeDiagnosticRequestRepo) GetByOrgIDReturnsOnCall(i int, result1 []model.DiagnosticRequest, result2 error) {
	fake.GetByOrgIDStub = nil
...
var _ model.DiagnosticRequestRepo = new(FakeDiagnosticRequestRepo)
